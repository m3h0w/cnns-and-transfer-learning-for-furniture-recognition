...
model = load_model('../model.h5', custom_objects={'imagenet_utils': imagenet_utils})
...
history = model.fit_generator(
    ...
    #   steps_per_epoch=train_generator.samples/train_generator.batch_size ,
      ...
      verbose=1,
      callbacks=[keras.callbacks.ModelCheckpoint('learnopencv1_checkpoint.h5', monitor='val_loss', verbose=2, save_best_only=True, mode='auto', period=1)])
